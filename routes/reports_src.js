...
exports.getInterviewStatusReport = function(req, res){
	...
	status_4 = 0
	data = {};
	var query = "SELECT COUNT(status_id) FROM interviewresponse_tbl Where status_id=";
...
exports.getInterviewModeReport = function(req, res){
	...
	status_3 = 0 
	data = {};
	var query = "SELECT COUNT(mode_id) FROM interviewresponse_tbl Where mode_id=";
	sequelize.query(query+"1").success(function(data) {
...
exports.getInterviewerStatusReport = function(req, res){
	...
	query += "interviewer_2_id="+req.params.id+") AND "
	query += "status_id=";
