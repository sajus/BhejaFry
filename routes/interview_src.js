...
exports.postInterview = function(req, res){
	var query = "INSERT INTO interviewresponse_tbl (candiateName, interviewer_1_id, interviewer_2_id, interviewDate ,recruiter_id, status_id, round_id, mode_id, description)";
	query += "VALUES (";
